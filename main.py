...
for intent in intents['intents']:
    ...
    for pregunta in intent['preguntas']:
        word_list = nltk.word_tokenize(pregunta)
...
palabras = [lemmatizer.lemmatize(word) for word in palabras if word not in ignorar_letras]
...
modelo.save('chatbot_model.model')
print('done')
'''